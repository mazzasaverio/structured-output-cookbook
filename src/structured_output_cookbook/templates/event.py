...
class EventSchema(BaseSchema):
    ...
    event_type: Union[str, None] = Field(description="Type of event: conference, workshop, party, meeting, etc.")
    category: Union[str, None] = Field(description="Category: business, social, educational, cultural, etc.")
    ...
    is_virtual: Union[bool, None] = Field(description="Whether the event is virtual/online")
    virtual_platform: Union[str, None] = Field(description="Platform for virtual events")
    
    # Organizer information
    organizer_name: Union[str, None] = Field(description="Name of the organizing person or entity")
    organizer_contact: Union[str, None] = Field(description="Contact information for organizer")
    organizing_company: Union[str, None] = Field(description="Company organizing the event")
    
    # Attendance information
    capacity: Union[int, None] = Field(description="Maximum number of attendees")
    expected_attendance: Union[int, None] = Field(description="Expected number of attendees")
    target_audience: List[str] = Field(description="Target audience or demographics")
    
    # Registration and costs
    registration_required: Union[bool, None] = Field(description="Whether registration is required")
    ...
    accessibility_info: Union[str, None] = Field(description="Accessibility information")
    parking_info: Union[str, None] = Field(description="Parking information")
    food_provided: Union[bool, None] = Field(description="Whether food/refreshments are provided")
    ...
    industries: List[str] = Field(description="Industries or sectors relevant to the event")
