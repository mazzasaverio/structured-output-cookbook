...
class ProductReviewSchema(BaseSchema):
    ...
    reviewer_name: Union[str, None] = Field(
        description="Name of the reviewer if mentioned"
    )
    purchase_verified: Union[bool, None] = Field(
    ...
    # Specific aspects
    value_for_money: Union[str, None] = Field(
    ...
    customer_service: Union[str, None] = Field(
    ...
    # Additional info
    usage_duration: Union[str, None] = Field(
