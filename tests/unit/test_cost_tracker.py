...
import pytest
from structured_output_cookbook.utils.cost_tracker import CostTracker, TokenUsage, CostInfo
...
class TestCostTracker:
    ...
    def test_normalize_model_name(self, cost_tracker):
        ...
        assert cost_tracker._normalize_model_name("gpt-4o-mini-2024-07-18") == "gpt-4o-mini"
        assert cost_tracker._normalize_model_name("gpt-4o-2024-08-06") == "gpt-4o"
        assert cost_tracker._normalize_model_name("gpt-4-turbo-preview") == "gpt-4-turbo"
        assert cost_tracker._normalize_model_name("gpt-4-0613") == "gpt-4"
        assert cost_tracker._normalize_model_name("gpt-3.5-turbo-0613") == "gpt-3.5-turbo"
    ...
    def test_get_model_recommendations(self, cost_tracker):
        ...
        assert (recommendations["gpt-4"]["cost_per_request"] > 
